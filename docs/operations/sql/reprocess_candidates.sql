...
-- 3) Conversations with inbound messages but no recent processing evidence (candidate: re-run handle_inbound_message)
-- Heuristic: last inbound message after last ai_run finished, or no ai_runs.
